...
現在は野球を中心に実装しており、Web上でチーム編集、ランダム編成、1試合、複数試合、12球団リーグ戦、クライマックスシリーズ、日本シリーズを実行できます。対戦・短期シリーズはトップページ、1年シーズンは `/season` に分けています。GitHub Pagesで静的サイトとして公開できるように、シミュレーション処理はブラウザ内で実行します。

公開URL:

```txt
https://jim-auto.github.io/team-sports-simulator/
https://jim-auto.github.io/team-sports-simulator/season
```
